...
class JanuaryTwoSixPTTwo(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "JanuaryTwoSixPTTwo" # TODO make this more human readable by adding spaces
...
#
# JanuaryTwoSixPTTwoWidget
#

class JanuaryTwoSixPTTwoWidget(ScriptedLoadableModuleWidget):
  ...
  def onApplyButton(self):
    logic = JanuaryTwoSixPTTwoLogic()
    enableScreenshotsFlag = self.enableScreenshotsFlagCheckBox.checked
    imageThreshold = self.imageThresholdSliderWidget.value
    logic.run(self.inputSelector.currentNode(), self.outputSelector.currentNode(), imageThreshold, enableScreenshotsFlag)

#
# JanuaryTwoSixPTTwoLogic
#

class JanuaryTwoSixPTTwoLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0):
    ...
    if enableScreenshots:
      self.takeScreenshot('JanuaryTwoSixPTTwoTest-Start','MyScreenshot',-1)
...
class JanuaryTwoSixPTTwoTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_JanuaryTwoSixPTTwo1()

  def test_JanuaryTwoSixPTTwo1(self):
    import numpy
